...
quintiles <- as.data.frame(rbind(colSums(ctppDataAggreg[2:13,]),
                   colSums(ctppDataAggreg[14:21,]),
                   colSums(ctppDataAggreg[22:23,]),
                   colSums(ctppDataAggreg[24,]),
                   colSums(ctppDataAggreg[25:26,])))
