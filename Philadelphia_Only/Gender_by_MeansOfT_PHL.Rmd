...
# Create new column Who
ctppData3$Who <- ctppData3$Pretty_Name
ctppData3$Who <- sub("Estimate; Total: - (\\S*):.*$", "\\1", ctppData3$Who)
ctppData3$Who <- sub("^.*(Total).*$", "\\1", ctppData3$Who)

ctppData <- ctppData3[c("Who","MeansOfT_Category", "Num_of_People")] 
ctppData
