---
title: "PovertyStatus_Countylevel_10Counties"
---

# Summary

* Process the CTPP data: Poverty Status at the County level for 10 counties (9 DVRPC counties + New Castle, DE.) 
...
tableName <- "PovertyStatus_Countylevel_10Counties"
...
# Rename the fields
names(ctppData) <- c("RESIDENCE",	"WORKPLACE",	"Total", "Under_PL", "Above_PL_100_to_149", "Above_PL_150_and_more")
...
ctppDataAggreg["Above_PL"] <-rowSums(ctppDataAggreg[,c("Above_PL_100_to_149", "Above_PL_150_and_more")])

# Remove detail columns
ctppDataAggreg <- ctppDataAggreg[c("RESIDENCE",	"WORKPLACE",	"Total", "Under_PL", "Above_PL")]
...
```{r Merge_two}
ctppDataPhilaAsResidenceTotal <- ctppDataPhilaAsResidence[c("RESIDENCE",	"WORKPLACE",	"Total", "Under_PL", "Above_PL")]
names(ctppDataPhilaAsResidenceTotal) <- c("RESIDENCE",	"WORKPLACE",	"TotalWp", "UndrPLWp", "AbvePLWp")

ctppDataPhilaAsWorkplaceTotal <- ctppDataPhilaAsWorkplace[c("RESIDENCE",	"WORKPLACE",	"Total", "Under_PL", "Above_PL")]
names(ctppDataPhilaAsWorkplaceTotal) <- c("RESIDENCE",	"WORKPLACE",	"TotalRe", "UndrPLRe", "AbvePLRe")
...
TenCountyTotals <- TenCountyTotals[c("WORKPLACE",	"TotalWp", "TotalRe", "UndrPLWp", "UndrPLRe", "AbvePLWp", "AbvePLRe")]
...
shpToWrite <- paste(home, outFolder, "PovertyStatus_TenCountyTotals.shp", sep="")
#shpToWrite
...
fileToWrite <- paste(home, outFolder,"PovertyStatus_TenCountyTotals.xlsx", sep="")
